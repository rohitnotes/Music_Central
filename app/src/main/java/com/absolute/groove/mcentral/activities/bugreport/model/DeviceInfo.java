package com.absolute.groove.mcentral.activities.bugreport.model;
...
public class DeviceInfo {
    ...
    public String toMarkdown() {
        return "Device info:\n"
                ...
                + "<tr><td>App version com</td><td>" + versionCode + "</td></tr>\n"
                ...
                + "<tr><td>Device absolute</td><td>" + device + "</td></tr>\n"
                + "<tr><td>Device model</td><td>" + model + "</td></tr>\n"
                + "<tr><td>Device product absolute</td><td>" + product + "</td></tr>\n"
                + "<tr><td>Device hardware absolute</td><td>" + hardware + "</td></tr>\n"
    ...
    public String toString() {
        return "App version: " + versionName + "\n"
                ...
                + "Device model: " + model + "\n"
                + "Device product absolute: " + product + "\n"
                + "Device hardware absolute: " + hardware + "\n"
