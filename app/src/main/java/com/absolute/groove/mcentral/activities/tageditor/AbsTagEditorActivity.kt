...
import com.absolute.groove.mcentral.R.drawable
import com.absolute.groove.mcentral.activities.base.AbsBaseActivity
import com.absolute.groove.mcentral.activities.saf.SAFGuideActivity
import com.absolute.groove.mcentral.util.RetroUtil
import com.absolute.groove.mcentral.util.SAFUtil
...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
    ...
    private fun setUpImageView() {
        loadCurrentImage()
        items = listOf(
            getString(com.absolute.groove.mcentral.R.string.pick_from_local_storage),
            getString(com.absolute.groove.mcentral.R.string.web_search),
            getString(com.absolute.groove.mcentral.R.string.remove_cover)
        )
