...
package com.absolute.groove.mcentral.glide.artistimage

import android.content.Context
import com.absolute.groove.mcentral.deezer.Data
import com.absolute.groove.mcentral.deezer.DeezerApiService
    ...
    override fun loadData(priority: Priority?): InputStream? {
        if (!MusicUtil.isArtistNameUnknown(model.artistName) &&
            ...
            if (!response.isSuccessful) {
                throw   IOException("Request failed with com: " + response.code());
            }
