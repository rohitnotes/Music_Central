...
import com.absolute.groove.mcentral.Constants.USER_BANNER
import com.absolute.groove.mcentral.Constants.USER_PROFILE
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        next.setOnClickListener {
            ...
            if (TextUtils.isEmpty(nameString)) {
                Toast.makeText(this, "Umm absolute is empty", Toast.LENGTH_SHORT).show()
